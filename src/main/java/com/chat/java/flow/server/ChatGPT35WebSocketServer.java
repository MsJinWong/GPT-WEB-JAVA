...
import com.chat.java.flow.chat.ChatGPT35RequestParameter;
import com.chat.java.flow.model.ChatGPT35Model;
...
@Component
@ServerEndpoint("/chatgpt35WebSocket/{userId}")
@Log4j2
public class ChatGPT35WebSocketServer {
     ...
     */
    private static ConcurrentHashMap<Long, ChatGPT35WebSocketServer> chatWebSocketMap = new ConcurrentHashMap<>();
    ...
    public void setAsyncLogService(AsyncLogService asyncLogService) {
        ChatGPT35WebSocketServer.asyncLogService = asyncLogService;
    }
    ...
    public void setCheckService(CheckService checkService) {
        ChatGPT35WebSocketServer.checkService = checkService;
    }

    ChatGPT35RequestParameter chatRequestParameter = new ChatGPT35RequestParameter();
